 ...
 */
            ...
            /**
            *  GetAllClientDetails bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllClientDetails
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAllClientDetails",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAllClientDetails",
    ...
    public static class Factory{
        ...
        */
        public static GetAllClientDetails parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllClientDetails object =
                new GetAllClientDetails();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAllClientDetails".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllClientDetails)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
