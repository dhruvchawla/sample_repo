 ...
 */
            ...
            /**
            *  GetRegionNameFromSC bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetRegionNameFromSC
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetRegionNameFromSC",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetRegionNameFromSC",
    ...
    public static class Factory{
        ...
        */
        public static GetRegionNameFromSC parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetRegionNameFromSC object =
                new GetRegionNameFromSC();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetRegionNameFromSC".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetRegionNameFromSC)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
