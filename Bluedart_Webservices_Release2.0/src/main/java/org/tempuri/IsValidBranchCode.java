 ...
 */
            ...
            /**
            *  IsValidBranchCode bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class IsValidBranchCode
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":IsValidBranchCode",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "IsValidBranchCode",
    ...
    public static class Factory{
        ...
        */
        public static IsValidBranchCode parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            IsValidBranchCode object =
                new IsValidBranchCode();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"IsValidBranchCode".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (IsValidBranchCode)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","BranchCode").equals(reader.getName()) || new javax.xml.namespace.QName("","BranchCode").equals(reader.getName()) ){
