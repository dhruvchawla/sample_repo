 ...
 */
            ...
            /**
            *  GetDTTChartReport bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetDTTChartReport
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetDTTChartReport",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetDTTChartReport",
    ...
    public static class Factory{
        ...
        */
        public static GetDTTChartReport parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDTTChartReport object =
                new GetDTTChartReport();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetDTTChartReport".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetDTTChartReport)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
