...
/**
 * GetMissedPickupSummaryReport.java
 *
 ...
 */
            ...
            /**
            *  GetMissedPickupSummaryReport bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetMissedPickupSummaryReport
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "GetMissedPickupSummaryReport",
                "ns13");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetMissedPickupSummaryReport",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetMissedPickupSummaryReport",
    ...
    public static class Factory{
        ...
        */
        public static GetMissedPickupSummaryReport parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMissedPickupSummaryReport object =
                new GetMissedPickupSummaryReport();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetMissedPickupSummaryReport".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetMissedPickupSummaryReport)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
