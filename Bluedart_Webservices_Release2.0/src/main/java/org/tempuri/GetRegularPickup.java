 ...
 */
            ...
            /**
            *  GetRegularPickup bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetRegularPickup
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetRegularPickup",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetRegularPickup",
    ...
    public static class Factory{
        ...
        */
        public static GetRegularPickup parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetRegularPickup object =
                new GetRegularPickup();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetRegularPickup".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetRegularPickup)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","pickupSerialNo").equals(reader.getName()) || new javax.xml.namespace.QName("","pickupSerialNo").equals(reader.getName()) ){
