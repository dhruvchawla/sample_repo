 ...
 */
            ...
            /**
            *  GetAllRouteCodes bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllRouteCodes
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAllRouteCodes",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAllRouteCodes",
    ...
    public static class Factory{
        ...
        */
        public static GetAllRouteCodes parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllRouteCodes object =
                new GetAllRouteCodes();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAllRouteCodes".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllRouteCodes)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
