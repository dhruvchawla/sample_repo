 ...
 */
            ...
            /**
            *  ReturnAllScheduledPickUp bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReturnAllScheduledPickUp
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "ReturnAllScheduledPickUp",
                "ns13");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReturnAllScheduledPickUp",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ReturnAllScheduledPickUp",
    ...
    public static class Factory{
        ...
        */
        public static ReturnAllScheduledPickUp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReturnAllScheduledPickUp object =
                new ReturnAllScheduledPickUp();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReturnAllScheduledPickUp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReturnAllScheduledPickUp)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
