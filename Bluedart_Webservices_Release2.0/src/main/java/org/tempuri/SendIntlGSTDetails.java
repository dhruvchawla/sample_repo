 ...
 */
            ...
            /**
            *  SendIntlGSTDetails bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SendIntlGSTDetails
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SendIntlGSTDetails",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SendIntlGSTDetails",
    ...
    public static class Factory{
        ...
        */
        public static SendIntlGSTDetails parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SendIntlGSTDetails object =
                new SendIntlGSTDetails();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SendIntlGSTDetails".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SendIntlGSTDetails)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
