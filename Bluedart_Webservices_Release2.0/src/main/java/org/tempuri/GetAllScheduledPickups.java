 ...
 */
            ...
            /**
            *  GetAllScheduledPickups bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllScheduledPickups
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAllScheduledPickups",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAllScheduledPickups",
    ...
    public static class Factory{
        ...
        */
        public static GetAllScheduledPickups parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllScheduledPickups object =
                new GetAllScheduledPickups();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAllScheduledPickups".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllScheduledPickups)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
