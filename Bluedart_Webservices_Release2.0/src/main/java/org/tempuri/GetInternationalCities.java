 ...
 */
            ...
            /**
            *  GetInternationalCities bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetInternationalCities
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetInternationalCities",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetInternationalCities",
    ...
    public static class Factory{
        ...
        */
        public static GetInternationalCities parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetInternationalCities object =
                new GetInternationalCities();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetInternationalCities".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetInternationalCities)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
