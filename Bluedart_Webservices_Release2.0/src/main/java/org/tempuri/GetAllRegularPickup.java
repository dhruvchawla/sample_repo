 ...
 */
            ...
            /**
            *  GetAllRegularPickup bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetAllRegularPickup
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetAllRegularPickup",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetAllRegularPickup",
    ...
    public static class Factory{
        ...
        */
        public static GetAllRegularPickup parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAllRegularPickup object =
                new GetAllRegularPickup();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetAllRegularPickup".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAllRegularPickup)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
