 ...
 */
            ...
            /**
            *  GetSCMessageonRoute bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetSCMessageonRoute
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetSCMessageonRoute",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetSCMessageonRoute",
    ...
    public static class Factory{
        ...
        */
        public static GetSCMessageonRoute parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSCMessageonRoute object =
                new GetSCMessageonRoute();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetSCMessageonRoute".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSCMessageonRoute)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","serviceCenter").equals(reader.getName()) || new javax.xml.namespace.QName("","serviceCenter").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","routeCode").equals(reader.getName()) || new javax.xml.namespace.QName("","routeCode").equals(reader.getName()) ){
