...
/**
 *  PickupProductDetails bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class PickupProductDetails implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = PickupProductDetails
     ...
     */
    protected com.microsoft.schemas._2003._10.serialization.arrays.ArrayOfstring localSubProductCode;
     ...
     */
    public com.microsoft.schemas._2003._10.serialization.arrays.ArrayOfstring getSubProductCode() {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":PickupProductDetails", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localSubProductCodeTracker) {
            if (localSubProductCode == null) {
                ...
                localSubProductCode.serialize(new javax.xml.namespace.QName(
                        "http://schemas.datacontract.org/2004/07/BD.Entities.Pickup",
                        "SubProductCode"), xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static PickupProductDetails parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            PickupProductDetails object = new PickupProductDetails();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"PickupProductDetails".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (PickupProductDetails) org.tempuri.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setFeature(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://schemas.datacontract.org/2004/07/BD.Entities.Pickup",
                            "SubProductCode").equals(reader.getName())) ||
                        new javax.xml.namespace.QName("", "SubProductCode").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        object.setSubProductCode(null);
                        reader.next();

                        reader.next();
                    } else {
                        object.setSubProductCode(com.microsoft.schemas._2003._10.serialization.arrays.ArrayOfstring.Factory.parse(
                                reader));
