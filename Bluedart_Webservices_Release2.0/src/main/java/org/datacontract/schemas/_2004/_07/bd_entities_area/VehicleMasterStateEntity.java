 ...
 */
            ...
            /**
            *  VehicleMasterStateEntity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class VehicleMasterStateEntity extends org.datacontract.schemas._2004._07.bd_entities_area.AreaEntity
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = VehicleMasterStateEntity
                ...
                */
                        ...
                        /**
                        * field for RegistrationCode
                        */

                        
                                    protected java.lang.String localRegistrationCode ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRegistrationCodeTracker = false ;

                           public boolean isRegistrationCodeSpecified(){
                               return localRegistrationCodeTracker;
                           }
                           ...
                           */
                           public  java.lang.String getRegistrationCode(){
                            ...
                            /**
                               ...
                               */
                               public void setRegistrationCode(java.lang.String param){
                            localRegistrationCodeTracker = true;
                                   
                                            this.localRegistrationCode=param;
                        ...
                        */
                                    ...
                                    protected com.microsoft.schemas._2003._10.serialization.arrays.ArrayOfstring localStateName ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.microsoft.schemas._2003._10.serialization.arrays.ArrayOfstring getStateName(){
                            ...
                            /**
                               ...
                               */
                               public void setStateName(com.microsoft.schemas._2003._10.serialization.arrays.ArrayOfstring param){
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VehicleMasterStateEntity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VehicleMasterStateEntity",
                           xmlWriter);
                   }
                ...
                if (localHandheldTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localRegistrationCodeTracker){
                                    namespace = "http://schemas.datacontract.org/2004/07/BD.Entities.Area";
                                    writeStartElement(null, namespace, "RegistrationCode", xmlWriter);
                                          ...
                                          if (localRegistrationCode==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localRegistrationCode);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (localStateName==null){
                                        ...
                                        writeStartElement(null, "http://schemas.datacontract.org/2004/07/BD.Entities.Area", "StateName", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localStateName.serialize(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/BD.Entities.Area","StateName"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static VehicleMasterStateEntity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VehicleMasterStateEntity object =
                new VehicleMasterStateEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VehicleMasterStateEntity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VehicleMasterStateEntity)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/BD.Entities.Area","RegistrationCode").equals(reader.getName()) || new javax.xml.namespace.QName("","RegistrationCode").equals(reader.getName()) ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/BD.Entities.Area","StateName").equals(reader.getName()) || new javax.xml.namespace.QName("","StateName").equals(reader.getName()) ){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setStateName(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setStateName(com.microsoft.schemas._2003._10.serialization.arrays.ArrayOfstring.Factory.parse(reader));
