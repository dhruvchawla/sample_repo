...
/**
 * AWBMPSLinkedPendingDataEntryEntityMPSData.java
 *
 ...
 */
            ...
            /**
            *  AWBMPSLinkedPendingDataEntryEntityMPSData bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AWBMPSLinkedPendingDataEntryEntityMPSData
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AWBMPSLinkedPendingDataEntryEntity.MPSData
                ...
                */
                        ...
                        */
                                    ...
                                    protected java.lang.String localMPSNumber ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMPSNumberTracker = false ;

                           public boolean isMPSNumberSpecified(){
                               return localMPSNumberTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getMPSNumber(){
                               return localMPSNumber;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MPSNumber
                               */
                               public void setMPSNumber(java.lang.String param){
                            localMPSNumberTracker = true;
                                   
                                            this.localMPSNumber=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AWBMPSLinkedPendingDataEntryEntity.MPSData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localContainerNumberTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localMPSNumberTracker){
                                    namespace = "http://schemas.datacontract.org/2004/07/BD.Entities.Area";
                                    writeStartElement(null, namespace, "MPSNumber", xmlWriter);
                             

                                          if (localMPSNumber==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localMPSNumber);
    ...
    public static class Factory{
        ...
        */
        public static AWBMPSLinkedPendingDataEntryEntityMPSData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AWBMPSLinkedPendingDataEntryEntityMPSData object =
                new AWBMPSLinkedPendingDataEntryEntityMPSData();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AWBMPSLinkedPendingDataEntryEntity.MPSData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AWBMPSLinkedPendingDataEntryEntityMPSData)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/BD.Entities.Area","MPSNumber").equals(reader.getName()) || new javax.xml.namespace.QName("","MPSNumber").equals(reader.getName()) ){
