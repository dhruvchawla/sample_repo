 ...
 */
            ...
            /**
            *  SCMessageReference bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SCMessageReference extends org.datacontract.schemas._2004._07.bd_entities_pickup.Pickup
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = SCMessageReference
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for TransmittedOrPassedFlg
                        */

                        
                                    protected java.lang.String localTransmittedOrPassedFlg ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localTransmittedOrPassedFlgTracker = false ;

                           public boolean isTransmittedOrPassedFlgSpecified(){
                               return localTransmittedOrPassedFlgTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getTransmittedOrPassedFlg(){
                               return localTransmittedOrPassedFlg;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param TransmittedOrPassedFlg
                               */
                               public void setTransmittedOrPassedFlg(java.lang.String param){
                            localTransmittedOrPassedFlgTracker = true;
                                   
                                            this.localTransmittedOrPassedFlg=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SCMessageReference",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SCMessageReference",
                ...
                if (localHandheldTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localTransmittedOrPassedFlgTracker){
                                    namespace = "http://schemas.datacontract.org/2004/07/BD.Entities.Pickup";
                                    writeStartElement(null, namespace, "TransmittedOrPassedFlg", xmlWriter);
                             

                                          if (localTransmittedOrPassedFlg==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localTransmittedOrPassedFlg);
    ...
    public static class Factory{
        ...
        */
        public static SCMessageReference parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SCMessageReference object =
                new SCMessageReference();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SCMessageReference".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SCMessageReference)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/BD.Entities.Pickup","TransmittedOrPassedFlg").equals(reader.getName()) || new javax.xml.namespace.QName("","TransmittedOrPassedFlg").equals(reader.getName()) ){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setTransmittedOrPassedFlg(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
