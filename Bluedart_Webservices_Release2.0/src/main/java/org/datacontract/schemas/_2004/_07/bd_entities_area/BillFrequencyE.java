 ...
 */
            ...
            /**
            *  BillFrequencyE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BillFrequencyE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localBillFrequency==null){
                                        ...
                                        writeStartElement(null, namespace, "BillFrequency", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localBillFrequency.serialize(MY_QNAME,xmlWriter);
                                       }
    ...
    public static class Factory{
        ...
        */
        public static BillFrequencyE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BillFrequencyE object =
                new BillFrequencyE();
