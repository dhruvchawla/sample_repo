 ...
 */
            ...
            /**
            *  StringIntergerEntity bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class StringIntergerEntity extends org.datacontract.schemas._2004._07.bd_entities_common.EntityBase
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = StringIntergerEntity
                ...
                */
                        ...
                        /**
                        * field for IntergerValue
                        */

                        
                                    protected int localIntergerValue ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localIntergerValueTracker = false ;

                           public boolean isIntergerValueSpecified(){
                               return localIntergerValueTracker;
                           }
                           ...
                           */
                           public  int getIntergerValue(){
                            ...
                            /**
                               ...
                               * @param param IntergerValue
                               */
                               public void setIntergerValue(int param){
                            
                                       // setting primitive attribute tracker to true
                                       localIntergerValueTracker =
                                       param != java.lang.Integer.MIN_VALUE;
                                   
                                            this.localIntergerValue=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":StringIntergerEntity",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "StringIntergerEntity",
                           xmlWriter);
                   }
                ...
                if (localHandheldTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localIntergerValueTracker){
                                    namespace = "http://schemas.datacontract.org/2004/07/BD.Entities.Common";
                                    writeStartElement(null, namespace, "IntergerValue", xmlWriter);
                             
                                               if (localIntergerValue==java.lang.Integer.MIN_VALUE) {
                                           
                                                         throw new org.apache.axis2.databinding.ADBException("IntergerValue cannot be null!!");
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localIntergerValue));
                                               }
    ...
    public static class Factory{
        ...
        */
        public static StringIntergerEntity parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            StringIntergerEntity object =
                new StringIntergerEntity();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"StringIntergerEntity".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (StringIntergerEntity)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/BD.Entities.Common","IntergerValue").equals(reader.getName()) || new javax.xml.namespace.QName("","IntergerValue").equals(reader.getName()) ){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"IntergerValue" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setIntergerValue(
                                        ...
                                        reader.next();
                                               ...
                                               object.setIntergerValue(java.lang.Integer.MIN_VALUE);
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/BD.Entities.Common","StringValue").equals(reader.getName()) || new javax.xml.namespace.QName("","StringValue").equals(reader.getName()) ){
