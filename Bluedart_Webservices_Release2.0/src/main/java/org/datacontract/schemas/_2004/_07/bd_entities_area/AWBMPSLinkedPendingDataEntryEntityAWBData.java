...
/**
 * AWBMPSLinkedPendingDataEntryEntityAWBData.java
 *
 ...
 */
            ...
            /**
            *  AWBMPSLinkedPendingDataEntryEntityAWBData bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AWBMPSLinkedPendingDataEntryEntityAWBData
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AWBMPSLinkedPendingDataEntryEntity.AWBData
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AWBMPSLinkedPendingDataEntryEntity.AWBData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static AWBMPSLinkedPendingDataEntryEntityAWBData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AWBMPSLinkedPendingDataEntryEntityAWBData object =
                new AWBMPSLinkedPendingDataEntryEntityAWBData();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AWBMPSLinkedPendingDataEntryEntity.AWBData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AWBMPSLinkedPendingDataEntryEntityAWBData)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
