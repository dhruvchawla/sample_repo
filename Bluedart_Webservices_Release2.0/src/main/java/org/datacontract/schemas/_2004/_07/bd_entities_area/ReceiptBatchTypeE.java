 ...
 */
            ...
            /**
            *  ReceiptBatchTypeE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReceiptBatchTypeE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localReceiptBatchType==null){
                                        ...
                                        writeStartElement(null, namespace, "ReceiptBatchType", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localReceiptBatchType.serialize(MY_QNAME,xmlWriter);
                                       }
    ...
    public static class Factory{
        ...
        */
        public static ReceiptBatchTypeE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReceiptBatchTypeE object =
                new ReceiptBatchTypeE();
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/BD.Entities.Area","ReceiptBatchType").equals(reader.getName()) || new javax.xml.namespace.QName("","ReceiptBatchType").equals(reader.getName()) ){
                                      ...
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setReceiptBatchType(null);
                                          reader.next();
