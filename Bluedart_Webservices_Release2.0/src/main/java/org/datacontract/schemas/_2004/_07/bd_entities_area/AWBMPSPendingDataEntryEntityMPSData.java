...
/**
 * AWBMPSPendingDataEntryEntityMPSData.java
 *
 ...
 */
            ...
            /**
            *  AWBMPSPendingDataEntryEntityMPSData bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AWBMPSPendingDataEntryEntityMPSData
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AWBMPSPendingDataEntryEntity.MPSData
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AWBMPSPendingDataEntryEntity.MPSData",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
    ...
    public static class Factory{
        ...
        */
        public static AWBMPSPendingDataEntryEntityMPSData parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AWBMPSPendingDataEntryEntityMPSData object =
                new AWBMPSPendingDataEntryEntityMPSData();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AWBMPSPendingDataEntryEntity.MPSData".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AWBMPSPendingDataEntryEntityMPSData)org.tempuri.imports.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
