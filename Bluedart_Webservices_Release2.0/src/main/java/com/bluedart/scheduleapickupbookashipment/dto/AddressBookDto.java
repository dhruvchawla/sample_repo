...
public class AddressBookDto implements Serializable {
	...
	private List<AddressBookDto> listOfDefltMstlyAddress;
	private List<AddressBookDto> listOfMatchedAddress;
	 ...
	 */
	public List<AddressBookDto> getListOfDefltMstlyAddress() {
		return listOfDefltMstlyAddress;
	}
	/**
	 * @param listOfDefltMstlyAddress the listOfDefltMstlyAddress to set
	 */
	public void setListOfDefltMstlyAddress(List<AddressBookDto> listOfDefltMstlyAddress) {
	 ...
	 */
	public List<AddressBookDto> getListOfMatchedAddress() {
		return listOfMatchedAddress;
	}
	/**
	 * @param listOfMatchedAddress the listOfMatchedAddress to set
	 */
	public void setListOfMatchedAddress(List<AddressBookDto> listOfMatchedAddress) {
