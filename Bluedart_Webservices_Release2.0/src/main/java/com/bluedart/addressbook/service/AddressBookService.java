package com.bluedart.addressbook.service;
...
public interface AddressBookService {
	...
	/*public List<AddressBookDto> getConsigneeAddressList(int pageNumber,int pageSize,String loginId,String name,String pincode,String addressType);
	public String addConsigneeAddress(AddressBookDto addressBookDto );
	public AddressBookDto renderEditConsigneeAddress(int addrId);
	public String updateConsigneeAddress(AddressBookDto addressBookDto);
	public String deleteConsigneeAddress(int addrId);
	public Map<String,ImportDto> importConsigneeAddress(File file,String loginId, String addressType);
	public List<AddressBookDto> exportConsigneeAddress(String loginId, String addressType) ;*/
