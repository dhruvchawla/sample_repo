 ...
 *
 */
public class ShipmentDtoCust implements SQLData, Serializable {
	...
	/**
	 * @param cpackdesc the cpackdesc to set
	 */
	...
	/**
	 * @param cpscode the cpscode to set
	 */
	...
	/**
	 * @param cPSNAME the cPSNAME to set
	 */
	...
	/**
	 * @param cSCRCDDESC the cSCRCDDESC to set
	 */
	public void setCSCRCDDESC(String cSCRCDDESC) {
		CSCRCDDESC = cSCRCDDESC;
	}
	...
	public void readSQL(SQLInput paramSQLInput, String typeName) throws SQLException {
		...
		setCPSNAME(paramSQLInput.readNString());
		setCSCRCD(paramSQLInput.readString());
		setCSCRCDDESC(paramSQLInput.readNString());
	}
