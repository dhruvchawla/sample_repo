...
@Entity
@Table(name = "CUSTMST")
public class CustMst implements Serializable {

	private static final long serialVersionUID = -2167448634928266238L;
	...
	/**
	 * @return the dtrackInsert
	 */
	public Timestamp getDtrackInsert() {
		return dtrackInsert;
	}

	/**
	 * @param dtrackInsert
	 *            the dtrackInsert to set
	 */
	public void setDtrackInsert(Timestamp dtrackInsert) {
		this.dtrackInsert = dtrackInsert;
	}

	/**
	 * @return the dtrackUpdate
	 */
	public Timestamp getDtrackUpdate() {
		return dtrackUpdate;
	}

	/**
	 * @param dtrackUpdate
	 *            the dtrackUpdate to set
	 */
	public void setDtrackUpdate(Timestamp dtrackUpdate) {
		this.dtrackUpdate = dtrackUpdate;
	}
